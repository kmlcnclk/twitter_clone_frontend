...
const RightSide: FunctionComponent<RightSideProps> = ({
  ...
  return (
    <div className="px-8 h-min">
      <div className="bg-white w-[350px] h-[53px] opacity-95 sticky right-0 top-0 flex justify-center items-center z-50">
        <div className="flex items-center px-1 py-3 w-[350px] h-[45px] bg-[#f7f9f9] rounded-full">
      ...
      <div className="">
        {relativePeopleState && bgColor && text && (
          <div
            className={`bg-[${bgColor}] rounded-2xl border-[1px] border-[#eff3f4] w-[350px] mt-4 h-auto`}
          >
